# RAK11300Lorawan
Semtech SX1262 LoRa driver for Micropython on RAK11300  

Credit: jgromes for [RadioLib](https://github.com/jgromes/RadioLib).  
This library is specific to use on the Rak Wireless RAK11300 Module

## Constructors   
***class*** **sx1262.SX1262(cs, irq, rst, gpio, clk, mosi, miso)**  
